...
namespace CarRentalApp
{
    public partial class ManageUsers : Form
    {
        ...
        {
            if (!Utils.FromIsOpen("AddUser"))
            {
                var addUserwindow = new AddUser(this);
                addUserwindow.MdiParent = this.MdiParent;
                addUserwindow.Show();
            }
        }
        ...
        private void btnResetPassword_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                //make it so the user can actualy edit the password
                var hashed_password = Utils.DefaultHashPassward();
